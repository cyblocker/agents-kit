...
window.I18N = {
    ...
    en: {
        ...
        daysCompleted: (d) => `~${d} days equivalent`,
    ...
    de: {
        ...
        phDesc: 'Freuen Sie sich auf die neue Saison! In der Zwischenzeit können Sie die vergangenen Saisons unten einsehen:',
        inputTotal: 'Aktuelle In-Game Punktzahl eingeben',
        inputPlaceholder: 'Zum Eingeben klicken',
        inputHint: 'Saison-Token gesamt',
        plannedRange: 'Prognostizierter Endbereich',
        calculatingStatus: 'Berechnung basierend auf Potenzial...',
        nextTierLabel: 'Bis zur nächsten Stufe',
        loading: 'Wird geladen...',
        thActivity: 'Aktivität',
        thMax: 'Max. Token',
        thPlanned: 'Geplant',
        thActual: 'Aktuell (Berechnet/Eingegeben)',
        thUpdated: 'Zuletzt aktualisiert',
        footerFormula: 'Tägliche Bounty-Punktzahl = Gesamt - Summe aller anderen tatsächlichen Punktzahlen.',
        seeRange: 'Voraussichtlichen Bereich ansehen',
        daysCompleted: (d) => `~${d} Tage äquivalent`,
        bountyHint: (p) => `Max. verbleibend ab morgen bis Saisonende: ${p} Token`,
        reachedPlatinum: 'Platin erreicht!',
        toTier: (name) => `Bis zur ${name}-Medaille`,
        maxTierForecast: (name) => `Prognostiziertes Max.: ${name}-Medaille`,
        noTierForecast: 'Nicht genug für eine Medaille',
        localTime: 'Ortszeit',
        contactMe: 'Kontaktieren Sie mich: ',
        textMigration: 'Datenmigration',
        btnShareUrl: 'Link & QR-Code teilen',
        btnExportJson: 'Als JSON exportieren',
        btnImportJson: 'JSON importieren',
        modalShareTitle: 'Daten teilen',
        modalShareDesc: 'Scannen Sie den QR-Code oder kopieren Sie den Link, um Ihren Plan auf anderen Geräten zu synchronisieren.',
        btnClose: 'Schließen',
        btnCopy: 'Link kopieren',
        copySuccess: 'Link in die Zwischenablage kopiert',
        syncConfirm: 'Synchronisationsdaten erkannt. Lokale Datensätze überschreiben?',
        importSuccess: 'Import erfolgreich!',
        invalidData: 'Ungültiges Datenformat!',
        wrongSeason: (s) => `Diese Daten gehören zu einer anderen Saison (${s}). Trotzdem importieren?`,
        confirmMergeAllSeasons: 'Mehrere Saisondaten erkannt. Alle lokalen Saisondatensätze überschreiben?',
        textCardModule: 'Erinnerungskarte',
        agentPlaceholder: 'Agentenname (Agent Name)',
        optThemeDefault: 'Standard (Dunkel)',
        optThemeRes: 'Widerstand (Blau)',
        optThemeEnl: 'Erleuchtete (Grün)',
        btnGenerateCard: 'Karte generieren',
        modalCardTitle: 'Erinnerungskarte speichern',
        modalCardDesc: 'Karte generiert! Auf dem PC Rechtsklick zum Speichern, auf Mobilgeräten das Bild lange gedrückt halten.',
        statBounties: 'Bounties',
        statIFS: 'IFS (First Saturday)',
        statEvents: 'Events & Ops',
        statAnomaly: 'Anomalie',
        pctComplete: (p) => `${p}% des Ziels`,
        bountyComplete: (p) => `${p}% abgeschlossen`,
        congratsCardMsg: (t) => `${t}-Medaille verdient!`,
        motivationBadge: (t) => `Herzlichen Glückwunsch zum Erreichen der ${t}-Medaille! Generieren Sie eine Karte, um sie zu teilen!`,
        motivationNormal: 'Die Saison neigt sich dem Ende zu. Generieren Sie Ihre personalisierte Erinnerungskarte!',
        startsIn: (t) => `Beginnt in ${t}`,
        endsIn: (t) => `Endet in ${t}`,
        ended: 'Beendet',
        unitDay: 'T.',
        unitHour: 'Std.',
        unitMinute: 'Min.',
        btnSyncLegacy: 'Von Legacy-Seite synchronisieren',
        btnManualImportStr: 'Manueller Import-String',
        migNoDataFound: 'Keine Datensätze für 2026 Q2 Orion im Migrations-Payload gefunden.',
        migOverwriteConfirm: 'Bestehenden Datensatz gefunden. Mit Legacy-Daten von cyblocker.com/ingress überschreiben? WARNUNG: Dies kann nicht rückgängig gemacht werden.',
        migSuccess: 'Migration erfolgreich! Ihre Legacy-Daten wurden importiert.',
        promptManualImport: 'Fügen Sie den manuellen Export-String ein (beginnend mit AGENTSKIT_):',
        migInvalidFormatStr: 'Ungültiges Format. Der String muss mit AGENTSKIT_ beginnen',
        migBannerTitle: 'Datenmigration',
        migBannerDesc: 'Es scheint, dass Sie noch keine Daten auf Agents Kit erfasst haben. Wenn Sie Datensätze auf der Legacy-Seite haben, können Sie diese jetzt synchronisieren.',
        limitLabel: 'Limit',
    }
};
...
window.generateCard = async function () {
    ...
    document.getElementById('ct-title-l2').textContent = (cardTitle !== 'cardTitle') ? cardTitle : t('pageTitle');
